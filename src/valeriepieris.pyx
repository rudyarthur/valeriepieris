...
cdef void expand(double [:, :] distance, double [:,:] data, cnp.int_t [:,:] ew, double [:] target_vars, int row, int col, int clat, int clon, int symm, int torad, double new_rad):
...
def call_expand(distance, data, ew, target, rad, rad_inc, dsum, clat, clon, symm=False, torad=False, new_rad=0):
	...
	cdef cnp.int_t [:,:] ew_view = ew

	expand(distance_view, data_view, ew_view, target_vars, row, col, lat, lon, symm , torad, xnew_rad)
	return target_vars[1], target_vars[2]


cdef void rshift(double [:, :] distance, double [:,:] data, cnp.int_t [:,:] ew, double [:] target_vars, int row, int col, int clat, int clon, int symm):
...
cdef void lshift(double [:, :] distance, double [:,:] data, cnp.int_t [:,:] ew, double [:] target_vars, int row, int col, int clat, int clon, int symm):
...
cdef void vshift(double [:, :] distance, double [:,:] data, cnp.int_t [:,:] ew, double [:] target_vars, int row, int col, int clat, int clon, int symm):
...
cdef void shrink(double [:, :] distance, double [:,:] data, cnp.int_t [:,:] ew, double [:] target_vars, int row, int col, int clat, int clon, int symm, int torad, double new_rad):
...
cdef void refine(double [:, :] distance, double [:,:] data, cnp.int_t [:,:] ew, double [:] target_vars, int row, int col, int clat, int clon, int symm, double thresh):
